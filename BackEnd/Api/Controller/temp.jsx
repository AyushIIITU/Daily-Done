  ...
  return (
    <>
      ...
      >
       ...
       {isDrawerOpen&& <div class="grid grid-cols-3 gap-4 p-4 lg:grid-cols-4">
...
// Drawer Items Data
const drawerItems = [
  { icon: "chart-icon", label: "Chart" },
  { icon: "table-icon", label: "Table" },
  { icon: "ticket-icon", label: "Ticket" },
  { icon: "list-icon", label: "List" },
  { icon: "price-icon", label: "Price" },
  { icon: "users-icon", label: "Users" },
  { icon: "task-icon", label: "Task" },
  { icon: "custom-icon", label: "Custom" },
];
  ...
  <div className="p-4 rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 dark:hover:bg-gray-600 dark:bg-gray-700">
    <div className="flex justify-center items-center p-2 mx-auto mb-2 bg-gray-200 dark:bg-gray-600 rounded-full w-[48px] h-[48px] max-w-[48px] max-h-[48px]">
      <svg
        ...
        fill="currentColor"
      >
        {/* Add paths for respective icons here */}
      </svg>
    </div>
