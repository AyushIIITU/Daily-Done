    ...
    <div className="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button" onClick={()=>setJoinGroupOpen(false)} className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="default-modal">
           ...
           {
              type==="Private" && (
                <form onSubmit={handleOnPrivateJoin} className="p-4 md:p-5 space-y-4">
    ...
    <div className="relative h-11 w-full min-w-[200px]">
      ...
      >
        Password
                ...
                <button type="submit" className="w-full py-2 bg-green-500 text-white rounded-lg">Join Group</button>
              </form>)
           }
           {
              type==="Public" && (
            ...
            <>
              ...
              >
                ...
                <button type="button" onClick={async () => await handleJoinPublic(item?._id)} className="w-full py-2 bg-green-500 text-white rounded-lg">Join Group</button>
